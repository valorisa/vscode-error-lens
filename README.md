...
|alignMessage|\{"start":0, "end":0, "minimumMargin":0, "useFixedPosition":true\}|Align inline error message (either by starting position or ending position). Only works for monospace fonts. Set "start" and "end" to **0** to disable.|
